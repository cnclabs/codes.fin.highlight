...
python3 tools/get_dataset_stats.py \
    -data data/fin10k/fin10k.annotation.type2.jsonl.1
...
python3 tools/extract_fin10k_eval_annotation.py \
    ...
    -annotator 3
python3 tools/get_dataset_stats.py \
    -data data/fin10k/fin10k.annotation.type2.jsonl.3
...
python3 tools/extract_fin10k_eval_annotation.py \
    ...
    -annotator 3
python3 tools/get_dataset_stats.py \
    -data data/fin10k/fin10k.annotation.type1.easy.jsonl.3
...
python3 tools/extract_fin10k_eval_annotation.py \
    ...
    -annotator 3
python3 tools/get_dataset_stats.py \
    -data data/fin10k/fin10k.annotation.type1.hard.jsonl.3
