...
parser.add_argument("-data", "--path_data", type=str)
parser.add_argument("-output_path", "--path_output_file", type=str)
parser.add_argument("-hl_B_only", "--labeling_on_sentB_only", action='store_true', default=False)
...
def convert_to_tokens_labeling(args):
    ...
    data = read_esnli(args.path_data, args.class_selected, args.reverse)
