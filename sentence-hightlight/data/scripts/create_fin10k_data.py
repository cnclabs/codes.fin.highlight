...
from utils import read_fin10k, load_master_dict, load_stopwords, extract_marks, token_extraction

def convert_to_bert_synthetic(args):
    nlp = English()
    data = read_fin10k(args.path_input_file, is_eval=("eval" in args.path_input_file))
    ...
    for i, example in enumerate(data):
        ...
        # update: keywordsA, keywordsB, labels
        if flag:
