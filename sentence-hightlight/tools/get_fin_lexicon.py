import argparse
import pandas as pd
from synthetic_utils import load_stopwords
...
def main(args):
    ...
    # file out dictionary
    f_sentiment = open('lexicons/LM.master_dictionary.sentiment.dict', 'w')
    f_stopword = open('lexicons/LM.master_dictionary.stopwords.dict', 'w')
    ...
    #         (1/data_non_sentiment['Word Count'] + 1/data_non_sentiment['Doc Count'])
    data_non_sentiment['RR'] = (1/data_non_sentiment['Doc Count'])
...
parser.add_argument("-LM_master_dict", "--path_lm_master_dict", type=str, \
        default='lexicons/Loughran-McDonald_MasterDictionary_1993-2021.csv')
parser.add_argument("-topk", "--truncated_by_k", type=int, default=None)
